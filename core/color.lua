...
function color.loadBuiltIns()
	is_internal = true
	color.indexColor("WHITE","rgb(255,255,255)")
	color.indexColor("MAROON","rgb(128,20,20)")
	color.indexColor("DARK_RED","rgb(139,20,20)")
	color.indexColor("BROWN","rgb(165,42,42)")
	color.indexColor("FIREBRICK","rgb(178,34,34)")
	color.indexColor("CRIMSON","rgb(220,20,60)")
	color.indexColor("TOMATO","rgb(255,99,71)")
	color.indexColor("CORAL","rgb(255,127,80)")
	color.indexColor("INDIAN_RED","rgb(205,92,92)")
	color.indexColor("LIGHT_CORAL","rgb(240,128,128)")
	color.indexColor("DARK_SALMON","rgb(233,150,122)")
	color.indexColor("SALMON","rgb(250,128,114)")
	color.indexColor("LIGHT_SALMON","rgb(255,160,122)")
	color.indexColor("ORANGE_RED","rgb(255,69,20)")
	color.indexColor("DARK_ORANGE","rgb(255,140,20)")
	color.indexColor("ORANGE","rgb(255,165,20)")
	color.indexColor("GOLD","rgb(255,215,20)")
	color.indexColor("DARK_GOLDEN_ROD","rgb(184,134,11)")
	color.indexColor("GOLDEN_ROD","rgb(218,165,32)")
	color.indexColor("PALE_GOLDEN_ROD","rgb(238,232,170)")
	color.indexColor("DARK_KHAKI","rgb(189,183,107)")
	color.indexColor("KHAKI","rgb(240,230,140)")
	color.indexColor("OLIVE","rgb(128,128,20)")
	color.indexColor("YELLOW_GREEN","rgb(154,205,50)")
	color.indexColor("DARK_OLIVE_GREEN","rgb(85,107,47)")
	color.indexColor("OLIVE_DRAB","rgb(107,142,35)")
	color.indexColor("LAWN_GREEN","rgb(124,252,20)")
	color.indexColor("CHART_REUSE","rgb(127,255,20)")
	color.indexColor("GREEN_YELLOW","rgb(173,255,47)")
	color.indexColor("DARK_GREEN","rgb(20,100,20)")
	color.indexColor("FOREST_GREEN","rgb(34,139,34)")
	color.indexColor("LIME","rgb(20,255,20)")
	color.indexColor("LIME_GREEN","rgb(50,205,50)")
	color.indexColor("LIGHT_GREEN","rgb(144,238,144)")
	color.indexColor("PALE_GREEN","rgb(152,251,152)")
	color.indexColor("DARK_SEA_GREEN","rgb(143,188,143)")
	color.indexColor("MEDIUM_SPRING_GREEN","rgb(20,250,154)")
	color.indexColor("SPRING_GREEN","rgb(20,255,127)")
	color.indexColor("SEA_GREEN","rgb(46,139,87)")
	color.indexColor("MEDIUM_AQUA_MARINE","rgb(102,205,170)")
	color.indexColor("MEDIUM_SEA_GREEN","rgb(60,179,113)")
	color.indexColor("LIGHT_SEA_GREEN","rgb(32,178,170)")
	color.indexColor("DARK_SLATE_GRAY","rgb(47,79,79)")
	color.indexColor("TEAL","rgb(20,128,128)")
	color.indexColor("DARK_CYAN","rgb(20,139,139)")
	color.indexColor("LIGHT_CYAN","rgb(224,255,255)")
	color.indexColor("DARK_TURQUOISE","rgb(20,206,209)")
	color.indexColor("TURQUOISE","rgb(64,224,208)")
	color.indexColor("MEDIUM_TURQUOISE","rgb(72,209,204)")
	color.indexColor("PALE_TURQUOISE","rgb(175,238,238)")
	color.indexColor("AQUA_MARINE","rgb(127,255,212)")
	color.indexColor("POWDER_BLUE","rgb(176,224,230)")
	color.indexColor("CADET_BLUE","rgb(95,158,160)")
	color.indexColor("STEEL_BLUE","rgb(70,130,180)")
	color.indexColor("CORN_FLOWER_BLUE","rgb(100,149,237)")
	color.indexColor("DEEP_SKY_BLUE","rgb(20,191,255)")
	color.indexColor("DODGER_BLUE","rgb(30,144,255)")
	color.indexColor("LIGHT_BLUE","rgb(173,216,230)")
	color.indexColor("SKY_BLUE","rgb(135,206,235)")
	color.indexColor("LIGHT_SKY_BLUE","rgb(135,206,250)")
	color.indexColor("MIDNIGHT_BLUE","rgb(25,25,112)")
	color.indexColor("NAVY","rgb(20,20,128)")
	color.indexColor("DARK_BLUE","rgb(20,20,139)")
	color.indexColor("MEDIUM_BLUE","rgb(20,20,205)")
	color.indexColor("BLUE","rgb(20,20,255)")
	color.indexColor("ROYAL_BLUE","rgb(65,105,225)")
	color.indexColor("BLUE_VIOLET","rgb(138,43,226)")
	color.indexColor("INDIGO","rgb(75,20,130)")
	color.indexColor("DARK_SLATE_BLUE","rgb(72,61,139)")
	color.indexColor("SLATE_BLUE","rgb(106,90,205)")
	color.indexColor("MEDIUM_SLATE_BLUE","rgb(123,104,238)")
	color.indexColor("MEDIUM_PURPLE","rgb(147,112,219)")
	color.indexColor("DARK_MAGENTA","rgb(139,20,139)")
	color.indexColor("DARK_VIOLET","rgb(148,20,211)")
	color.indexColor("DARK_ORCHID","rgb(153,50,204)")
	color.indexColor("MEDIUM_ORCHID","rgb(186,85,211)")
	color.indexColor("PURPLE","rgb(128,20,128)")
	color.indexColor("THISTLE","rgb(216,191,216)")
	color.indexColor("PLUM","rgb(221,160,221)")
	color.indexColor("VIOLET","rgb(238,130,238)")
	color.indexColor("MAGENTA","rgb(255,20,255)")
	color.indexColor("ORCHID","rgb(218,112,214)")
	color.indexColor("MEDIUM_VIOLET_RED","rgb(199,21,133)")
	color.indexColor("PALE_VIOLET_RED","rgb(219,112,147)")
	color.indexColor("DEEP_PINK","rgb(255,20,147)")
	color.indexColor("HOT_PINK","rgb(255,105,180)")
	color.indexColor("LIGHT_PINK","rgb(255,182,193)")
	color.indexColor("PINK","rgb(255,192,203)")
	color.indexColor("ANTIQUE_WHITE","rgb(250,235,215)")
	color.indexColor("BEIGE","rgb(245,245,220)")
	color.indexColor("BISQUE","rgb(255,228,196)")
	color.indexColor("BLANCHED_ALMOND","rgb(255,235,205)")
	color.indexColor("WHEAT","rgb(245,222,179)")
	color.indexColor("CORN_SILK","rgb(255,248,220)")
	color.indexColor("LEMON_CHIFFON","rgb(255,250,205)")
	color.indexColor("LIGHT_GOLDEN_ROD_YELLOW","rgb(250,250,210)")
	color.indexColor("LIGHT_YELLOW","rgb(255,255,224)")
	color.indexColor("SADDLE_BROWN","rgb(139,69,19)")
	color.indexColor("CALM_PURPLE","rgb(85,85,127)")
	color.indexColor("SIENNA","rgb(160,82,45)")
	color.indexColor("CHOCOLATE","rgb(210,105,30)")
	color.indexColor("PERU","rgb(205,133,63)")
	color.indexColor("SANDY_BROWN","rgb(244,164,96)")
	color.indexColor("BURLY_WOOD","rgb(222,184,135)")
	color.indexColor("TAN","rgb(210,180,140)")
	color.indexColor("ROSY_BROWN","rgb(188,143,143)")
	color.indexColor("MOCCASIN","rgb(255,228,181)")
	color.indexColor("NAVAJO_WHITE","rgb(255,222,173)")
	color.indexColor("PEACH_PUFF","rgb(255,218,185)")
	color.indexColor("MISTY_ROSE","rgb(255,228,225)")
	color.indexColor("LAVENDER_BLUSH","rgb(255,240,245)")
	color.indexColor("LINEN","rgb(250,240,230)")
	color.indexColor("OLD_LACE","rgb(253,245,230)")
	color.indexColor("PAPAYA_WHIP","rgb(255,239,213)")
	color.indexColor("SEA_SHELL","rgb(255,245,238)")
	color.indexColor("MINT_CREAM","rgb(245,255,250)")
	color.indexColor("SLATE_GRAY","rgb(112,128,144)")
	color.indexColor("LIGHT_SLATE_GRAY","rgb(119,136,153)")
	color.indexColor("LIGHT_STEEL_BLUE","rgb(176,196,222)")
	color.indexColor("LAVENDEr(","rgb(230,230,250)")
	color.indexColor("FLORAL_WHITE","rgb(255,250,240)")
	color.indexColor("ALICE_BLUE","rgb(240,248,255)")
	color.indexColor("GHOST_WHITE","rgb(248,248,255)")
	color.indexColor("HONEYDEW","rgb(240,255,240)")
	color.indexColor("IVORY","rgb(255,255,240)")
	color.indexColor("AZURE","rgb(240,255,255)")
	color.indexColor("SNOW","rgb(255,250,250)")
	color.indexColor("DIM_GRAY","rgb(105,105,105)")
	color.indexColor("GRAY","rgb(128,128,128)")
	color.indexColor("DARK_GRAY","rgb(169,169,169)")
	color.indexColor("SILVEr(","rgb(192,192,192)")
	color.indexColor("LIGHT_GRAY","rgb(211,211,211)")
	color.indexColor("GAINSBORO","rgb(220,220,220)")
	color.indexColor("WHITE_SMOKE","rgb(245,245,245)")
...
is_internal = false
-- Add guard against non existing colors
setmetatable(color,{
	__index = function(t,k)
		...
		return error("Attempt to index non existing color: '".. k .."'")
	end
})
